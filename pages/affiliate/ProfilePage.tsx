...
import { LogoutIcon, TrophyIcon, LightbulbIcon, GiftIcon, ChevronRightIcon, DocumentMagnifyingGlassIcon } from '../../components/icons/Icons';
...
const ProfilePage: React.FC = () => {
    ...
    return (
        <div className="p-4 space-y-6">
            <h2 className="text-xl font-bold text-text-primary text-center">My Profile</h2>
            ...
            <Card>
                <CardContent>
                    <h3 className="font-bold text-lg text-text-primary mb-4">Account Information</h3>
                    <form onSubmit={handleSave} className="space-y-4">
                        <Input label="Email Address" type="email" value={user?.email} disabled className="bg-black/20"/>
            ...
            <Card>
                <CardContent>
                    <h3 className="font-bold text-lg text-text-primary mb-4">Change Password</h3>
            ...
            <Card>
                <CardContent>
                    <h3 className="font-bold text-lg text-text-primary">Support Center</h3>
                    <p className="text-sm mt-1 text-text-secondary">Facing an issue? Let us know.</p>
    ...
    return (
        <Link to={to} className="flex items-center justify-between py-4 group">
            <div className="flex items-center">
                <Icon className="h-6 w-6 text-text-secondary group-hover:text-primary" />
                <span className="ml-4 font-medium text-text-primary group-hover:text-primary">{label}</span>
            </div>
