...
import { listenToContentRewardCampaigns } from '../../services/mockApi';
...
const ContentRewardsPage: React.FC = () => {
    ...
    useEffect(() => {
        setLoading(true);
        const unsubscribe = listenToContentRewardCampaigns(data => {
            setCampaigns(data);
            setLoading(false);
        });
        return () => unsubscribe();
    ...
    return (
        <div className="p-4 space-y-4">
            <div className="text-center">
                <h1 className="text-2xl font-bold text-text-primary">Content Rewards</h1>
