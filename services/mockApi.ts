...
export const markSurveyAsActioned = async (submission: SurveySubmission): Promise<void> => {
    ...
    await createTicket({
        ...
        message: `Hi ${submission.affiliateTiktok},\n\nThank you for your valuable feedback: "${submission.choice}". We have reviewed your suggestion and our team will look into it. We appreciate you helping us improve the Creator Hub!\n\nBest,\nThe Admin Team`,
    });
};
