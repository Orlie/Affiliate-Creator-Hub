        ...
        <Card className="bg-primary/10 border border-primary/30">
            <CardContent className="relative">
                <button 
                    ...
                    className="absolute top-2 right-2 text-text-secondary/50 hover:text-text-secondary"
                ...
                <h3 className="text-lg font-bold text-primary">Friendly Reminder: Stay Active, Get Samples!</h3>
                <p className="mt-2 text-sm text-primary/80">
                    To continue being eligible for new free samples, please create at least one video per week featuring a partner product. Let's grow together!
                </p>
            </CardContent>
        </Card>
    );
